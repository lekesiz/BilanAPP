...
Appointment.belongsTo(Beneficiary, { foreignKey: 'beneficiaryId', as: 'beneficiary' });
User.hasMany(Appointment, { foreignKey: 'consultantId', as: 'consultantAppointments' });
Beneficiary.hasMany(Appointment, { foreignKey: 'beneficiaryId', as: 'beneficiaryAppointments' });

// Relations pour les messages
Message.belongsTo(User, { foreignKey: 'consultantId', as: 'consultant' });
Message.belongsTo(Beneficiary, { foreignKey: 'beneficiaryId', as: 'beneficiary' });
Message.belongsTo(User, { foreignKey: 'senderId', as: 'sender' });
User.hasMany(Message, { foreignKey: 'consultantId', as: 'consultantMessages' });
Beneficiary.hasMany(Message, { foreignKey: 'beneficiaryId', as: 'beneficiaryMessages' });
User.hasMany(Message, { foreignKey: 'senderId', as: 'sentMessages' });

// Relations pour les questionnaires
Questionnaire.belongsTo(User, { foreignKey: 'createdBy', as: 'creator' });
Questionnaire.belongsTo(Beneficiary, { foreignKey: 'beneficiaryId', as: 'beneficiary' });
User.hasMany(Questionnaire, { foreignKey: 'createdBy', as: 'createdQuestionnaires' });
Beneficiary.hasMany(Questionnaire, { foreignKey: 'beneficiaryId', as: 'assignedQuestionnaires' });
...
Beneficiary.hasMany(Document, { foreignKey: 'beneficiaryId', as: 'beneficiaryDocuments' });
...
Answer.belongsTo(Beneficiary, { foreignKey: 'beneficiaryId', as: 'beneficiary' });
